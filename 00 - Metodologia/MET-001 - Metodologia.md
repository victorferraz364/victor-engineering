...
Cada entidade possui responsabilidade própria e pode ser utilizada por diversas outras, evitando duplicação de informações.
...
O Projeto Victor utiliza relacionamentos entre documentos como principal forma de organização lógica.

As pastas representam apenas categorias de artefatos.

Os documentos são conectados por referências.

Exemplo:

OBJ-001 → PROJ-001 → LAB-002 → VID-001

Um projeto pode atender diversos objetivos.

Um laboratório pode apoiar vários projetos.

Um conteúdo pode documentar diversos laboratórios.

Um recurso de estudo pode servir para vários objetivos.

Sempre que possível, evita-se duplicar informações.

---

# 6. Artefatos

Durante o desenvolvimento poderão ser produzidos diferentes tipos de artefatos, como:
...
Essas referências servem como base conceitual para o desenvolvimento do projeto, podendo ser adaptadas sempre que necessário.

---

# 9. Evolução da Metodologia

A metodologia do Projeto Victor é um documento vivo.
