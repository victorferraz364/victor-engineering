...
O Projeto Victor surge como uma iniciativa para estruturar esse processo utilizando princípios inspirados em Engenharia de Software, Análise de Sistemas, Engenharia de Soluções e Gerenciamento de Projetos, transformando o aprendizado em um processo organizado e incremental.
...
Planejar, organizar, executar e documentar continuamente o desenvolvimento de conhecimentos, habilidades e competências por meio de estudos, laboratórios, projetos práticos e produção de conteúdo técnico.
...
- o conhecimento deve produzir evidências concretas de sua aplicação.
...
O desenvolvimento do projeto poderá ser influenciado por fatores como:
...
- necessidade de conciliar estudos, projetos, produção de conteúdo e demais atividades.
...
- servir como referência para novos estudos, projetos e futuras evoluções.
...
Ao longo de sua evolução, o projeto poderá produzir diferentes tipos de artefatos, incluindo:
