...
Seu objetivo é manter o foco da iniciativa, evitar o crescimento descontrolado do escopo (_scope creep_) e garantir que o projeto permaneça alinhado ao seu propósito original.

---

# Escopo

O Projeto Victor é responsável por planejar, organizar, documentar e acompanhar o desenvolvimento contínuo de conhecimentos, habilidades e competências por meio de uma abordagem estruturada baseada em objetivos de aprendizado, projetos práticos e produção de evidências.

O projeto atua como um sistema central de gestão do desenvolvimento, conectando objetivos, projetos, laboratórios, recursos e conteúdos produzidos ao longo da jornada de aprendizagem.

---

# Faz Parte do Escopo

O Projeto Victor contempla:
...
O Projeto Victor **não** tem como objetivo substituir outras ferramentas ou sistemas especializados.
...
O Projeto Victor atua como um sistema de coordenação e documentação do desenvolvimento.
...
O escopo poderá evoluir conforme o Projeto Victor amadurecer.

Toda alteração deverá preservar o propósito central do projeto e buscar manter sua simplicidade, organização e foco no desenvolvimento contínuo do produto.